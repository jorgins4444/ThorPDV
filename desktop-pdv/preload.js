...
contextBridge.exposeInMainWorld('thor', {
  ...
  printSaleCancellation: (receipt) => ipcRenderer.invoke('thor:print-sale-cancellation', receipt),
  ...
  operationHistory: (filters = {}) => ipcRenderer.invoke('thor:operation-history', filters),
  reprintOperation: (payload = {}) => ipcRenderer.invoke('thor:reprint-operation', payload),
  pendingOperations: () => ipcRenderer.invoke('thor:pending-operations'),
  retryOperation: (eventId) => ipcRenderer.invoke('thor:retry-operation', eventId),
  retryPendingOperations: () => ipcRenderer.invoke('thor:retry-pending-operations'),
  authorizeSensitiveAction: (payload = {}) => ipcRenderer.invoke('thor:authorize-sensitive-action', payload),
  draftSales: (query = '') => ipcRenderer.invoke('thor:draft-sales', query),
  saveDraftSale: (payload = {}) => ipcRenderer.invoke('thor:save-draft-sale', payload),
  loadDraftSale: (id) => ipcRenderer.invoke('thor:load-draft-sale', id),
  completeDraftSale: (id, eventId = '') => ipcRenderer.invoke('thor:complete-draft-sale', id, eventId),
  deleteDraftSale: (id) => ipcRenderer.invoke('thor:delete-draft-sale', id),
