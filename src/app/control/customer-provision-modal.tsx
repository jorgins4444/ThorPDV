...
const blank={
 ...
 admin_email:'',contact:'',responsible:'',license_status:'trial',management_user_limit:'5',pdv_terminal_limit:'1',expires_at:'',notes:'',
};
