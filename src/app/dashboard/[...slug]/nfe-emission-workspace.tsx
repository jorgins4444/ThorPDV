...
export function NfeEmissionWorkspace({ settings, documents, sales, customers, products }: Props) {
  ...
  async function createFromSale() {
    ...
    const result = await nfeSaleDraftCreate(saleId, saleSeriesId || undefined, { nature_operation: natureOperation.trim() || 'VENDA DE MERCADORIA', purpose, presence, consumer_final: consumerFinal });
    setBusy(false);
